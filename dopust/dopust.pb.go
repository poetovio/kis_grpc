...
type GetZaposlenRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetZaposlenRequest) Reset() {
	*x = GetZaposlenRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dopust_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetZaposlenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetZaposlenRequest) ProtoMessage() {}

func (x *GetZaposlenRequest) ProtoReflect() protoreflect.Message {
	mi := &file_dopust_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetZaposlenRequest.ProtoReflect.Descriptor instead.
func (*GetZaposlenRequest) Descriptor() ([]byte, []int) {
	return file_dopust_proto_rawDescGZIP(), []int{13}
}

func (x *GetZaposlenRequest) GetIdZaposlen() int64 {
	if x != nil {
		return x.IdZaposlen
	}
	return 0
...
type DeleteZaposlenResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DeleteZaposlenResponse) Reset() {
	*x = DeleteZaposlenResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dopust_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DeleteZaposlenResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteZaposlenResponse) ProtoMessage() {}

func (x *DeleteZaposlenResponse) ProtoReflect() protoreflect.Message {
	mi := &file_dopust_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteZaposlenResponse.ProtoReflect.Descriptor instead.
func (*DeleteZaposlenResponse) Descriptor() ([]byte, []int) {
	return file_dopust_proto_rawDescGZIP(), []int{14}
}

func (x *DeleteZaposlenResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
type UpdateZaposlenRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UpdateZaposlenRequest) Reset() {
	*x = UpdateZaposlenRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dopust_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UpdateZaposlenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateZaposlenRequest) ProtoMessage() {}

func (x *UpdateZaposlenRequest) ProtoReflect() protoreflect.Message {
	mi := &file_dopust_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateZaposlenRequest.ProtoReflect.Descriptor instead.
func (*UpdateZaposlenRequest) Descriptor() ([]byte, []int) {
	return file_dopust_proto_rawDescGZIP(), []int{15}
}

func (x *UpdateZaposlenRequest) GetIdZaposlenega() int64 {
	if x != nil {
		return x.IdZaposlenega
	}
	return 0
...
func (x *UpdateZaposlenRequest) GetIme() string {
	if x != nil {
		return x.Ime
	}
	return ""
...
func (x *UpdateZaposlenRequest) GetPriimek() string {
	if x != nil {
		return x.Priimek
	}
	return ""
...
func (x *UpdateZaposlenRequest) GetSpol() string {
	if x != nil {
		return x.Spol
	}
	return ""
...
func (x *UpdateZaposlenRequest) GetDatumRojstva() string {
	if x != nil {
		return x.DatumRojstva
	}
	return ""
...
func (x *UpdateZaposlenRequest) GetPodjetje() string {
	if x != nil {
		return x.Podjetje
	}
	return ""
...
type DatumStreamResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DatumStreamResponse) Reset() {
	*x = DatumStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dopust_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DatumStreamResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DatumStreamResponse) ProtoMessage() {}

func (x *DatumStreamResponse) ProtoReflect() protoreflect.Message {
	mi := &file_dopust_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DatumStreamResponse.ProtoReflect.Descriptor instead.
func (*DatumStreamResponse) Descriptor() ([]byte, []int) {
	return file_dopust_proto_rawDescGZIP(), []int{16}
}

func (x *DatumStreamResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *DatumStreamResponse) GetIdZaposlenega() int64 {
	if x != nil {
		return x.IdZaposlenega
	}
	return 0
...
func (x *DatumStreamResponse) GetDatumZacetka() string {
	if x != nil {
		return x.DatumZacetka
	}
	return ""
...
func (x *DatumStreamResponse) GetDatumKonca() string {
	if x != nil {
		return x.DatumKonca
	}
	return ""
...
func (x *DatumStreamResponse) GetVrstaDopusta() string {
	if x != nil {
		return x.VrstaDopusta
	}
	return ""
...
func (x *DatumStreamResponse) GetStevilkaDopusta() int64 {
	if x != nil {
		return x.StevilkaDopusta
	}
	return 0
...
type GetEnZaposlenRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetEnZaposlenRequest) Reset() {
	*x = GetEnZaposlenRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dopust_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetEnZaposlenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetEnZaposlenRequest) ProtoMessage() {}

func (x *GetEnZaposlenRequest) ProtoReflect() protoreflect.Message {
	mi := &file_dopust_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetEnZaposlenRequest.ProtoReflect.Descriptor instead.
func (*GetEnZaposlenRequest) Descriptor() ([]byte, []int) {
	return file_dopust_proto_rawDescGZIP(), []int{17}
}

func (x *GetEnZaposlenRequest) GetIdZaposlen() int64 {
	if x != nil {
		return x.IdZaposlen
	}
	return 0
...
type GetZaposlenResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetZaposlenResponse) Reset() {
	*x = GetZaposlenResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dopust_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetZaposlenResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetZaposlenResponse) ProtoMessage() {}

func (x *GetZaposlenResponse) ProtoReflect() protoreflect.Message {
	mi := &file_dopust_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetZaposlenResponse.ProtoReflect.Descriptor instead.
func (*GetZaposlenResponse) Descriptor() ([]byte, []int) {
	return file_dopust_proto_rawDescGZIP(), []int{18}
}

func (x *GetZaposlenResponse) GetIdZaposlenega() int64 {
	if x != nil {
		return x.IdZaposlenega
	}
	return 0
...
func (x *GetZaposlenResponse) GetIme() string {
	if x != nil {
		return x.Ime
	}
	return ""
...
func (x *GetZaposlenResponse) GetPriimek() string {
	if x != nil {
		return x.Priimek
	}
	return ""
...
func (x *GetZaposlenResponse) GetSpol() string {
	if x != nil {
		return x.Spol
	}
	return ""
...
func (x *GetZaposlenResponse) GetDatumRojstva() string {
	if x != nil {
		return x.DatumRojstva
	}
	return ""
...
func (x *GetZaposlenResponse) GetPodjetje() string {
	if x != nil {
		return x.Podjetje
	}
	return ""
...
var file_dopust_proto_rawDesc = []byte{
	...
	,
}
...
var file_dopust_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_dopust_proto_goTypes = []interface{}{
	...
	(*GetZaposlenRequest)(nil),     // 13: dopust.GetZaposlenRequest
	(*DeleteZaposlenResponse)(nil), // 14: dopust.DeleteZaposlenResponse
	(*UpdateZaposlenRequest)(nil),  // 15: dopust.UpdateZaposlenRequest
	(*DatumStreamResponse)(nil),    // 16: dopust.DatumStreamResponse
	(*GetEnZaposlenRequest)(nil),   // 17: dopust.GetEnZaposlenRequest
	(*GetZaposlenResponse)(nil),    // 18: dopust.GetZaposlenResponse
}
var file_dopust_proto_depIdxs = []int32{
	...
	5,  // 4: dopust.DopustService.UpdateDopust:input_type -> dopust.UpdateDopustRequest
	4,  // 5: dopust.DopustService.DeleteDopust:input_type -> dopust.GetDopustRequest
	17, // 6: dopust.DopustService.GetZaposlen:input_type -> dopust.GetEnZaposlenRequest
	...
	15, // 9: dopust.DopustService.UpdateZaposlen:input_type -> dopust.UpdateZaposlenRequest
	13, // 10: dopust.DopustService.DeleteZaposlen:input_type -> dopust.GetZaposlenRequest
	8,  // 11: dopust.StreamDopust.DopustStream:input_type -> dopust.GetDopustiRequest
	0,  // 12: dopust.DopustService.CreateDopust:output_type -> dopust.Dopust
	0,  // 13: dopust.DopustService.GetDopust:output_type -> dopust.Dopust
	0,  // 14: dopust.DopustService.UpdateDopust:output_type -> dopust.Dopust
	7,  // 15: dopust.DopustService.DeleteDopust:output_type -> dopust.DeleteDopustResponse
	1,  // 16: dopust.DopustService.GetZaposlen:output_type -> dopust.Zaposlen
	1,  // 17: dopust.DopustService.CreateZaposlen:output_type -> dopust.Zaposlen
	10, // 18: dopust.DopustService.GetZaposleni:output_type -> dopust.ZaposlenList
	1,  // 19: dopust.DopustService.UpdateZaposlen:output_type -> dopust.Zaposlen
	14, // 20: dopust.DopustService.DeleteZaposlen:output_type -> dopust.DeleteZaposlenResponse
	16, // 21: dopust.StreamDopust.DopustStream:output_type -> dopust.DatumStreamResponse
...
func file_dopust_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_dopust_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetZaposlenRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dopust_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteZaposlenResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dopust_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateZaposlenRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dopust_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DatumStreamResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dopust_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetEnZaposlenRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dopust_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetZaposlenResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
